...
hook.Add( "CanPlayerEnterVehicle", "UPSCanEnterVehicle", canEnterVehicle, HOOK_HIGH )
...
hook.Add( "CanPlayerUnfreeze", "UPSCanUnfreeze", canUnfreeze, HOOK_HIGH )
...
hook.Add( "CanTool", "UPSCanTool", canTool, HOOK_HIGH )
...
hook.Add( "CanProperty", "UPSCanProperty", canProperty, HOOK_HIGH )
...
hook.Add( "EntityTakeDamage", "UPSCanDamage", canDamage, HOOK_HIGH )
...
hook.Add( "GravGunPickupAllowed", "UPSCanPickup", canPickup, HOOK_HIGH )
hook.Add( "GravGunPunt", "UPSCanPunt", canPickup, HOOK_HIGH )
...
hook.Add( "OnPhysgunFreeze", "UPSCanFreeze", canFreeze, HOOK_HIGH )
...
hook.Add( "PhysgunPickup", "UPSCanPhysgun", canPhysgun, HOOK_HIGH )
...
hook.Add( "PlayerUse", "UPSCanUse", canUse, HOOK_HIGH )
